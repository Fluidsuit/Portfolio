...
import photo from '../assets/Meher.jpg'
      ...
      <div className="home-top">
        ...
        >
          ...
          <p className="typing-effect">
            FullStack Developer  | BackEnd Developer | Tech Explorer
          </p>
          ...
          <motion.div className="info-cards">
            {[
              ...
              { label: '💼 Expertise', value: 'FullStack Developer, Problem Solving' },
              { label: '📧 Contact', value: 'mehertank@gmail.com' },
            ].map((info, i) => (
