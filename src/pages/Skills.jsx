...
const ROWS = [
  [
    { title: "Programming Languages", items: ["Core Java", "Java 8", "JavaScript", "SQL"] },
    { title: "Web Technologies", items: ["HTML", "CSS", "JavaScript", "Bootstrap", "Tailwind CSS", "React JS", "JSP"] },
    { title: "Databases & Tools", items: ["MySQL", "Eclipse", "IntelliJ IDEA", "VS Code", "Git", "GitHub", "Postman", "Maven"] },
    { title: "Frameworks & Libraries", items: ["Spring", "Spring Boot", "Spring MVC", "Spring Security", "Hibernate"] },
  ],
  [
    {
      title: "Core Concepts",
